...
CUDA_VISIBLE_DEVICES=2 python tianshou_td3bc.py --random_noise=-1 --ADD_TASKBIT=False --USE_DATASET_STR="walk_m,walk_mr" --task walk &

# wait

CUDA_VISIBLE_DEVICES=0 python tianshou_td3bc.py --random_noise=-1 --ADD_TASKBIT=True --USE_DATASET_STR="run_m,run_mr" --task run &
wait
CUDA_VISIBLE_DEVICES=2 python tianshou_td3bc.py  --random_noise=-1 --ADD_TASKBIT=False --USE_DATASET_STR="run_m,run_mr" --task run &

CUDA_VISIBLE_DEVICES=2 python tianshou_td3bc.py --random_noise=-1 --ADD_TASKBIT=True --USE_DATASET_STR="__all__" --task walk &
