...
echo "Part2"
# CUDA_VISIBLE_DEVICES=0 python decision-transformer/gym/experiment_dmc.py --USE_DATASET_STR walk_m,walk_mr --task_bit True --noise -1 --save_model True
CUDA_VISIBLE_DEVICES=1 python decision-transformer/gym/experiment_dmc.py --USE_DATASET_STR run_m,run_mr --task_bit True --noise 0.00001 --save_model True &
CUDA_VISIBLE_DEVICES=1 python decision-transformer/gym/experiment_dmc.py --USE_DATASET_STR run_m,run_mr --task_bit True --noise 0.0001 --save_model True &
CUDA_VISIBLE_DEVICES=1 python decision-transformer/gym/experiment_dmc.py --USE_DATASET_STR run_m,run_mr --task_bit True --noise 0.001 --save_model True &
CUDA_VISIBLE_DEVICES=2 python decision-transformer/gym/experiment_dmc.py --USE_DATASET_STR run_m,run_mr --task_bit True --noise 0.01 --save_model True &
CUDA_VISIBLE_DEVICES=2 python decision-transformer/gym/experiment_dmc.py --USE_DATASET_STR run_m,run_mr --task_bit True --noise 0.1 --save_model True  &

echo "Part3"
CUDA_VISIBLE_DEVICES=2 python decision-transformer/gym/experiment_dmc.py --USE_DATASET_STR __all__ --task_bit True --noise 0.00001 --save_model True &
CUDA_VISIBLE_DEVICES=2 python decision-transformer/gym/experiment_dmc.py --USE_DATASET_STR __all__ --task_bit True --noise 0.0001 --save_model True &
CUDA_VISIBLE_DEVICES=1 python decision-transformer/gym/experiment_dmc.py --USE_DATASET_STR __all__ --task_bit True --noise 0.001 --save_model True &
