...
CUDA_VISIBLE_DEVICES=2 python tianshou_cql.py --random_noise=0.00001 --ADD_TASKBIT=True --USE_DATASET_STR="walk_m,walk_mr" --task walk
CUDA_VISIBLE_DEVICES=2 python tianshou_cql.py --random_noise=0.0001 --ADD_TASKBIT=True --USE_DATASET_STR="walk_m,walk_mr" --task walk
CUDA_VISIBLE_DEVICES=2 python tianshou_cql.py --random_noise=0.001 --ADD_TASKBIT=True --USE_DATASET_STR="walk_m,walk_mr" --task walk
CUDA_VISIBLE_DEVICES=2 python tianshou_cql.py --random_noise=0.01 --ADD_TASKBIT=True --USE_DATASET_STR="walk_m,walk_mr" --task walk
CUDA_VISIBLE_DEVICES=2 python tianshou_cql.py --random_noise=0.1 --ADD_TASKBIT=True --USE_DATASET_STR="walk_m,walk_mr" --task walk
 
echo "Part2"
CUDA_VISIBLE_DEVICES=2 python tianshou_cql.py --random_noise=-1 --ADD_TASKBIT=True --USE_DATASET_STR="run_m,run_mr" --task run
CUDA_VISIBLE_DEVICES=2 python tianshou_cql.py --random_noise=0.00001 --ADD_TASKBIT=True --USE_DATASET_STR="run_m,run_mr" --task run
CUDA_VISIBLE_DEVICES=2 python tianshou_cql.py --random_noise=0.0001 --ADD_TASKBIT=True --USE_DATASET_STR="run_m,run_mr" --task run
CUDA_VISIBLE_DEVICES=2 python tianshou_cql.py --random_noise=0.001 --ADD_TASKBIT=True --USE_DATASET_STR="run_m,run_mr" --task run
CUDA_VISIBLE_DEVICES=2 python tianshou_cql.py --random_noise=0.01 --ADD_TASKBIT=True --USE_DATASET_STR="run_m,run_mr" --task run
CUDA_VISIBLE_DEVICES=2 python tianshou_cql.py --random_noise=0.1 --ADD_TASKBIT=True --USE_DATASET_STR="run_m,run_mr" --task run
