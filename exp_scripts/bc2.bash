...
XLA_FLAGS=--xla_gpu_enable_command_buffer= CUDA_VISIBLE_DEVICES=1 python train_il.py train --random_noise=0.00001  --ADD_TASK_BIT=True --USE_DATASET_STR="walk_m" --TEST_AFTER_TRAINING=True
...
XLA_FLAGS=--xla_gpu_enable_command_buffer= CUDA_VISIBLE_DEVICES=1 python train_il.py train --random_noise=0.001  --ADD_TASK_BIT=True --USE_DATASET_STR="walk_m" --TEST_AFTER_TRAINING=True
...
XLA_FLAGS=--xla_gpu_enable_command_buffer= CUDA_VISIBLE_DEVICES=1 python train_il.py train --random_noise=0.00001 --ADD_TASK_BIT=True --USE_DATASET_STR="run_m" --TEST_AFTER_TRAINING=True
XLA_FLAGS=--xla_gpu_enable_command_buffer= CUDA_VISIBLE_DEVICES=1 python train_il.py train --random_noise=0.0001 --ADD_TASK_BIT=True --USE_DATASET_STR="run_m" --TEST_AFTER_TRAINING=True
XLA_FLAGS=--xla_gpu_enable_command_buffer= CUDA_VISIBLE_DEVICES=1 python train_il.py train --random_noise=0.001 --ADD_TASK_BIT=True --USE_DATASET_STR="run_m" --TEST_AFTER_TRAINING=True
